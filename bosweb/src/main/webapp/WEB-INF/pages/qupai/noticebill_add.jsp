        ...
        <table class="table-edit" width="100%" align="center">
            ...
            <tr>
                ...
                <td><input type="text" class="easyui-validatebox" name="telephone"
                    ...
                    <script type="text/javascript">
                        $(function () {
                            //    页面加载完成之后，为输入框绑定一个失去焦点的事件
                            $("input[name=telephone]").blur(function () {
                                //获取页面输入的手机号
                                var value = this.value;
                                //    this指的是通过属性选择器获得到的对象
                                //    发送ajax请求我们的action,然后远程调用crm服务来获取客户信息
                                $.post('noticebillAction_findcustomerByTelephone', {"telephone": value}, function (data) {
                                    if (data != null) {
                                        var name = data.name;
                                        var id = data.id;
