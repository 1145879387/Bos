    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#save').click(function () {
                ...
                <%--cto 先进行表单检验--%>
                var form = $("#functionForm").form("validate");
                if (form) {
                    $("#functionForm").submit();
                }
            });
    ...
    <form id="functionForm" method="post" action="${pageContext.request.contextPath}/functionaction_add">
        <table class="table-edit" width="80%" align="center">
            ...
            <tr>
                <td>父功能点</td>
                <td>
                    <%--<input name="parentFunction.id" class="easyui-combotree" data-options="url:'functionaction_list'" style="width: 170px;"/>--%>
                    <input class="easyui-combotree" name="parentFunction.id"
                           data-options="url:'functionaction_list.action'"
                           style="width:170px;">
                </td>
            </tr>
            <tr>
