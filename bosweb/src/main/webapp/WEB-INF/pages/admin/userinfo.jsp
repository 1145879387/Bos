        ...
        <table class="table-edit" width="95%" align="center">
            ...
            <tr>
                ...
                <td colspan="3" id="roleTd">
                    <script type="text/javascript">
                        $(function () {
                            //页面加载完成后加载ajax请求来获得数据
                            $.post('roleaction_listajax', function (data) {
                                // alert(data);
                                //在ajax中解析json数据，转换成checkbox
                                for (const obj of data) {
                                    var id = obj.id;
                                    var name = obj.name;
                                    //使用lable标签会自动选择lable标签里的属性框
                                    $("#roleTd").append('<input id="' + id + '" type="checkbox" name="rowIds" value="' + id + '"><label for="' + id + '">' + name + '</label>');
                                }
                            });
                        });
                    </script>
